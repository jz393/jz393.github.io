...
**Self-destructive attachment** is a common theme throughout **literature** and **history**. For a while, I debated on which field to portray here, then realized they actually form a recursive engine. We write literature based on history. We consume literature, which influences our way of thinking and, therefore, our future actions. For sake of simplicity, I’ll focus on literature, the artistic generative output, over the *(comparatively stale)* input data. One example that stood out to me was F. Scott Fitzgerald’s portrayal of Gatsby.
