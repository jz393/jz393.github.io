...
- 1 tbsp oyster sauce
- 1 tbsp soy sauce
- 1 tbsp gochugaru (red chili flakes, found in most Asian supermarkets)
- low sodium chicken broth
- 1 egg *(optional)*
- green onion, 1/2 bunch *(optional)*
- salt to taste

### steps
1. heat up pot with seasame oil on the bottom
2. dice onion and add to pot, stir until soft
3. mix in oyster sauce, soy sauce, and gochugaru until combined
4. add chicken broth (~2-3 cups) depending on how much soup and what consistency you want
5. add vegetables (mushrooms/zucchini), tofu (cut into ~1 in cubes), and seafood (shellfish/squid/shrimp) to broth after it comes to a boil
